...
export default function LeftLargeArea() {
  return (
    <motion.div
      ...
      '
    >
      {/* Bagian atas: Judul & Deskripsi rata tengah + margin top */}
      <div className='flex flex-col items-center text-center space-y-6 mt-20'>
        ...
        <div className='max-w-[662px]'>
          <p className='font-[Gully] font-normal text-[26px] leading-[1.5] text-white'>
            A glimpse of paradise from the edge of the world.
          </p>
        </div>
      </div>

      {/* Rating tetap rata kiri */}
      <div className='w-full flex justify-start'>
        <p className='font-[Gully] font-normal text-[40px] leading-[1.4] text-white'>
          4.93/5.00 |{" "}
          <span className='text-[28px] text-white'>32k+ explorers</span>
        </p>
      </div>
    </motion.div>
  );
