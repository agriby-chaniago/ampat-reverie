  ...
  return (
    <motion.div
      ...
      className='
        ...
        justify-between
        w-full lg:w-[716px]
        h-auto min-h-[220px] sm:min-h-[280px] lg:h-[360px]
        bg-white
        bg-opacity-70
        shadow
      ...
      '
    >
      {/* Header content with responsive typography */}
      ...
      <div className='w-full flex justify-center mb-1 sm:mb-2'>
        <a
          ...
          className='
            w-full
            max-w-full sm:max-w-[500px] lg:max-w-[574px]
            h-[50px] sm:h-[60px] md:h-[70px] lg:h-[78px]
            bg-[#102437]
            text-white
            rounded-full
            flex
