...
export default function GalleryVisual() {
  ...
  const dynamicEl = [
    {
      src: "/assets/img/gallery/GalleryVisual_Photo1.jpg",
      thumb: "/assets/img/gallery/GalleryVisual_Photo1.jpg",
    },
    {
      src: "/assets/img/gallery/GalleryVisual_Photo2.jpg",
      thumb: "/assets/img/gallery/GalleryVisual_Photo2.jpg",
    },
    {
      src: "/assets/img/gallery/GalleryVisual_Photo3.jpg",
      thumb: "/assets/img/gallery/GalleryVisual_Photo3.jpg",
    },
    {
      src: "/assets/img/gallery/GalleryVisual_Photo4.jpg",
      thumb: "/assets/img/gallery/GalleryVisual_Photo4.jpg",
    },
    {
      src: "/assets/img/gallery/GalleryVisual_Photo5.jpg",
      thumb: "/assets/img/gallery/GalleryVisual_Photo5.jpg",
    },
    {
      src: "/assets/img/gallery/GalleryVisual_Photo6.jpg",
      thumb: "/assets/img/gallery/GalleryVisual_Photo6.jpg",
    },
  ];
  ...
  return (
    <div
      id='gallery'
      className='relative min-h-screen w-full pt-48 bg-cover bg-top bg-no-repeat'
      style={{
